    ...
    return (  
        ...
        <div>
            <nav className='flex w-full md:p-[1%] bg-white justify-between'>
              ...
              <div className={`md:flex  p-[4%] md:p-[0%] block justify-around m-[0] left-[5%] text-[#9698A6] md:left-0 md:m-0 md:static absolute w-[90%] top-[150%] md:top-0 rounded-[5%] text-center bg-white md:justify-between  ${open ? "block" : "hidden"}`}>
